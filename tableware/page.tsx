...
export default function Chairs(){
    ...
    const products = [
        {
          image: "/tableware2.PNG", // Replace with actual image paths
          name: "The Golden Rim Plate",
          price: "£230",
        },
        {
          image: "/tableware3.PNG",
          name: "The Cozy Morning Mug",
          price: "£155",
        },
        {
          image: "/tableware4.PNG",
          name: "The Aurora Serving Bowl",
          price: "£125",
        },
        {
          image: "/tableware5.PNG",
          name: "The Velvet Steam Teapot",
          price: "£399",
        },
      ];
  ...
  >
    <h2 className="text-2xl font-bold mb-2">The Candle Holders Set </h2>
    <p className="text-xl text-gray-900 mb-4">£250</p>
    <p className="text-base text-gray-700 mb-6">
  A stunning set of three pillar candle holders featuring a rich midnight blue <br/>finish 
  and elegant metallic accents. Each piece showcases a unique sculpted design,<br/> 
  adding a touch of sophistication and warmth to any living space or dining table.
</p>
    {/* Features List */}
